...
public class Marketplace {
    ...
    public static void main(String[] args) {
        ...
        Comprador comprador1 = new Comprador("Zezao", "135");
        Comprador comprador2 = new Comprador("william", "coxinha");
        compradores.add(comprador1);
        compradores.add(comprador2);

        Vendedor vendedor1 = new Vendedor("vendedor1", "111");
        Vendedor vendedor2 = new Vendedor("vendedor2", "222");
        vendedores.add(vendedor1);
        vendedores.add(vendedor2);

        Produto produto1 = new Produto("10 trufas sortidas", 50.0, vendedor1);
        Produto produto2 = new Produto("Barra de chocolate 90%", 25.0, vendedor1);
        Produto produto3 = new Produto("Caixa surpresa", 150.0, vendedor2);
